...
document.getElementById("speakBtn").addEventListener("click", function () {
    ...
    bingClientTTS.synthesize("line1:how are you", BingTTS.SupportedLocales.jpJP_Female);
    bingClientTTS.synthesize("line2:天気がいいから、散歩しましょう。", BingTTS.SupportedLocales.jpJP_Female);
